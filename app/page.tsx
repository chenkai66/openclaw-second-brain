...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* 全屏搜索区域 */}
      <section className="relative min-h-[100dvh] flex flex-col items-center justify-center px-4 pb-32">
        {/* 背景渐变 */}
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-purple-900/20 dark:to-slate-900"></div>
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto text-center -mt-20">
          ...
          {/* 标题 */}
          <h1 className="text-6xl md:text-7xl font-bold mb-5 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
            Second Brain
          </h1>
          
          {/* 副标题 */}
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-10">
            AI-Powered Knowledge Management · Never Forget Your Ideas
          </p>
          
          {/* 搜索框 */}
          <div className="mb-10 flex justify-center">
            <div className="w-full max-w-2xl">
              <SearchBar placeholder="Search notes and logs..." autoFocus={true} />
            </div>
          </div>
          
          {/* 统计信息 */}
          <div className="flex items-center justify-center gap-6 md:gap-10 text-sm md:text-base flex-wrap">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
              <span className="text-gray-600 dark:text-gray-400">Live Sync</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-xl text-indigo-600 dark:text-indigo-400">{notes.length}</span>
              <span className="text-gray-600 dark:text-gray-400">Notes</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-xl text-purple-600 dark:text-purple-400">{logs.length}</span>
              <span className="text-gray-600 dark:text-gray-400">Logs</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-bold text-xl text-pink-600 dark:text-pink-400">{reports.length}</span>
      ...
      {/* 内容区域 */}
      <div id="content-section" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-2xl p-8 text-white hover:shadow-2xl transition-all duration-300 group cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90">
                  Visualize relationships between notes, logs, and tags
                </p>
              </div>
            </div>
          </Link>
          ...
          <Link href="/research">
            <div className="relative overflow-hidden bg-gradient-to-br from-orange-500 via-red-500 to-pink-500 rounded-2xl p-8 text-white hover:shadow-2xl transition-all duration-300 group cursor-pointer">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90">
                  In-depth tech research and industry analysis
                </p>
              </div>
            </div>
          </Link>
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">In-depth technical research reports</p>
                </div>
        ...
        <section>
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Daily Logs</h2>
            <p className="text-gray-600 dark:text-gray-400">Automatically recorded conversation history and activity traces</p>
          </div>
